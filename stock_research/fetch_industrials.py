...
plot_dir = "./industrials_hist/95_prob_sharpe_plots"
...
# 2. Plot overall Sharpe ratios with 95% CI error bars for the top 5 stocks plus the SPY.
...
plt.title("Overall Sharpe Ratio with 95% CI (Top 5 Stocks and SPY)")
plt.xlabel("Ticker")
